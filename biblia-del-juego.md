...
> **Versión:** v0.23 · **Fecha:** 6 de mayo de 2026 · **Autor:** Bazalo con dirección de el-teknomoro-director
...
**Estado hoy (6 mayo 2026):** biblia en v0.23. **H0, H1, H2 y H3 cerrados, PASO 4 del H3 archivado, cuestionario de scope de H4 cerrado, sub-paso 4a cerrado, cuestionario de scope de 4b cerrado.** El primer loop completo del juego (crear PJ → home → combate al Lobo → loot/epitafio → persistencia → home) corre en producción con statuses funcionales, 10 perks cableados, IA con 4 perfiles + intent visible, y `flee` 50% implementado. **390/390 tests verde**, `tsc --noEmit` limpio, `vite build` limpio. Los 5 bloqueantes de diseño que restaban (v0.8) están cerrados (decisiones #41-#45 más #46 emergente). Lore (#47), reordenamiento de hitos (#62) y decisiones del cuestionario de visión (#63 en adelante) cerradas en v0.20. Decisiones del PASO 4 del H3 (#78-#80) cerradas en v0.21. Decisiones del cuestionario de scope de H4 (#81-#85) cerradas en v0.22. Decisiones del cuestionario de scope del sub-paso 4b (#86-#91) cerradas en v0.23.
...
| 4c | Vista de POI minimalista + entrada al combate Lobo, saltable con coste (#86). Zoom continuo a vista de POI. Persistencia de POIs revelados. Sistema de pausa global. Home reinterpretada como POI del Sur + campamento completo (decisión #87). | SÍ |
